...
test("resolveAdminNextPath redirects agents away from /admin/logs", () => {
  assert.equal(resolveAdminNextPath("agent", "/admin/logs"), "/admin/agent");
});
...
test("resolveAdminNextPath redirects agents away from /admin/riders", () => {
  assert.equal(resolveAdminNextPath("agent", "/admin/riders"), "/admin/agent");
});
