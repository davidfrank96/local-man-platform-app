...
function createRiderInsertPayload(data: CreateAdminRiderRequest) {
  ...
  return {
    ...
    weekday_available_from: data.weekday_available_from ?? null,
    weekday_available_until: data.weekday_available_until ?? null,
    weekend_available_from: data.weekend_available_from ?? null,
    weekend_available_until: data.weekend_available_until ?? null,
    verification_status: verificationStatus,
    visibility_status: visibilityStatus,
