...
export const vendorIntakeRowInputSchema = z.object({
  ...
  category_1: vendorIntakeRawTextSchema,
  category_2: vendorIntakeRawTextSchema,
  category_3: vendorIntakeRawTextSchema,
  category_4: vendorIntakeRawTextSchema,
  category_5: vendorIntakeRawTextSchema,
  category_6: vendorIntakeRawTextSchema,
  ...
  dish_3_name: vendorIntakeRawTextSchema,
  dish_3_description: vendorIntakeRawTextSchema,
  dish_3_image_url: vendorIntakeRawTextSchema,
