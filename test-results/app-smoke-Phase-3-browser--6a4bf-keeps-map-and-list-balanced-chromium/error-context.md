...
- Name: app-smoke.spec.ts >> Phase 3 browser smoke >> tablet layout keeps map and list balanced
- Location: tests/e2e/app-smoke.spec.ts:1141:3
...
Locator: locator('.discovery-layout')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.discovery-layout')
