...
- Name: app-smoke.spec.ts >> Phase 3 browser smoke >> night theme keeps cards readable and selected state clear
- Location: tests/e2e/app-smoke.spec.ts:1020:3
...
Call log:
  ...
  - waiting for locator('.public-shell')
