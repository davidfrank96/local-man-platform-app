...
- Name: layout-stress.spec.ts >> Layout stress >> dense results and rapid interactions stay stable
- Location: tests/e2e/layout-stress.spec.ts:192:3
...
Call log:
  ...
  - waiting for locator('.vendor-card')
