...
- Name: app-smoke.spec.ts >> Phase 3 browser smoke >> retry clears denied state and reloads nearby vendors after precise location succeeds
- Location: tests/e2e/app-smoke.spec.ts:585:3
