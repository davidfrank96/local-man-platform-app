...
- Name: app-smoke.spec.ts >> Phase 3 browser smoke >> fallback map remains usable when the MapLibre style request fails
- Location: tests/e2e/app-smoke.spec.ts:497:3
...
Locator: locator('.discovery-map[data-map-mode="fallback"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.discovery-map[data-map-mode="fallback"]')
