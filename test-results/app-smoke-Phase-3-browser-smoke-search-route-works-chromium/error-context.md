...
- Name: app-smoke.spec.ts >> Phase 3 browser smoke >> search route works
- Location: tests/e2e/app-smoke.spec.ts:549:3
...
Locator: getByRole('heading', { name: 'Search local food' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Search local food' })
