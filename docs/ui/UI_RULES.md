...
- Rider Connect form helper text should state the accepted customer phone examples and the delivery-mode requirement before users search for riders
...
- Rider Connect and rating prompt modals/sheets should trap focus, close on `Escape`, and return focus to the trigger
